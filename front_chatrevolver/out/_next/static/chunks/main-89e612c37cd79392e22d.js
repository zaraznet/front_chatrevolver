                ...
                value: function () {
                  this.scrollToHash(),
                    Z.isSsr &&
                      ...
                      "/_error" !== N &&
                      (B ||
                        (j.nextExport && (y.isDynamicRoute(Z.pathname) || location.search)) ||
                        (T && T.__N_SSG && location.search)) &&
                      Z.replace(
                        Z.pathname +
                          "?" +
                          String(g.assign(g.urlQueryToSearchParams(Z.query), new URLSearchParams(location.search))),
                        Q,
                        { _h: 1, shallow: !B }
                      );
                },
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 36:
                      return (
                        (t.router = Z = O.createRouter(N, D, Q, {
                          initialProps: T,
                          pageLoader: K,
                          App: ee,
                          Component: oe,
                        ...
                        se((c = { App: ee, initial: !0, Component: oe, props: T, err: r })),
                        e.abrupt("return", ie)
                      );
                    case 43:
          ...
          K.loadPage("/_error")
            ...
            .then(function (r) {
              ...
              return Promise.resolve(e.props ? e.props : _.loadGetInitialProps(t, u)).then(function (t) {
                return ge(L({}, e, { err: n, Component: o, styleSheets: a, props: t }));
              });
            })
        );
      }
    ...
    7926: function (e, t, r) {
      ...
      var m = function (e) {
        ...
        return (
          ...
          "beforeInteractive" === f &&
            (y
              ? ((g.beforeInteractive = (g.beforeInteractive || []).concat([s({ src: r, onLoad: i, onError: d }, v)])),
                y(g))
              : b && b()
              ? p.add(v.id || r)
              : b && !b() && h(e)),
        ...
        function e(t, r, n, o) {
          ...
          if (
            ...
            (w._shouldResolveHref = n !== t),
              this.changeState("replaceState", p.formatWithValidation({ pathname: E(t), query: r }), p.getURL(), w);
          }
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 47:
                              return (
                                (t.prev = 47), (t.t0 = t.catch(37)), (window.location.href = a), t.abrupt("return", !1)
                              );
                            case 51:
                              if (
                                ...
                                l &&
                                  ...
                                  (M.pathname = A(L, N)),
                                  M.pathname !== L &&
                                    ((L = M.pathname), (M.pathname = E(L)), (o = p.formatWithValidation(M)))),
                            ...
                            case 61:
                              ...
                              if (
                                !(
                                  (V = Object.keys(B.groups).filter(function (e) {
                                    return !I[e];
                                  })).length > 0
                                )
                              ) {
                            ...
                            case 76:
                              G
                                ? (a = p.formatWithValidation(
                                    Object.assign({}, U, { pathname: z.result, query: R(I, z.params) })
                                  ))
                                : Object.assign(I, W);
                            case 77:
                              return (
                            ...
                            case 81:
                              ...
                              return (
                                ((te = h.parseRelativeUrl(ee)).pathname = A(te.pathname, N)),
                                (re = j(this, ee, ee)),
                                (ne = re.url),
                                (oe = re.as),
                                ...
                                i._h &&
                                  ...
                                  500 ===
                                    ...
                                    void 0 === X
                                      ? void 0
                                      : X.statusCode) &&
                                  (null === Y || void 0 === Y ? void 0 : Y.pageProps) &&
                                  (Y.pageProps.statusCode = 500),
                                (ie = i.shallow && this.route === H),
                                (ce = null !== (ue = i.scroll) && void 0 !== ue ? ue : !ie),
                                (se = ce ? { x: 0, y: 0 } : null),
                                (t.next = 116),
                                this.set(H, L, I, _, $, null !== u && void 0 !== u ? u : se).catch(function (e) {
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 13:
                              if ((d = { props: undefined, Component: l, styleSheets: f, err: r, error: r }).props) {
                                t.next = 25;
                                break;
                              }
                              return (
                                (t.prev = 15), (t.next = 18), this.getInitialProps(l, { err: r, pathname: o, query: a })
                              );
                            case 18:
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 12:
                              (f = e.sent),
                                ...
                                d.matchedPage &&
                                  d.resolvedHref &&
                                  ((i = d.resolvedHref), (a.pathname = i), (t = p.formatWithValidation(a))),
                                (e.next = 21);
                              break;
                            case 19:
                              (a.pathname = A(a.pathname, u)),
                                a.pathname !== i &&
                                  ((i = a.pathname), (a.pathname = i), (t = p.formatWithValidation(a)));
                            case 21:
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 17:
                    ...
                    throw (
                      ((i = '"'
                        .concat(h(t), '.getInitialProps()" should resolve to an object. But found "')
                        .concat(a, '" instead.')),
                      new Error(i))
                    );
                  case 20:
    ...
    5666: function (e) {
      var t = (function (e) {
        ...
        return (
          ...
          (e.mark = function (e) {
            return (
              Object.setPrototypeOf ? Object.setPrototypeOf(e, g) : ((e.__proto__ = g), c(e, u, "GeneratorFunction")),
